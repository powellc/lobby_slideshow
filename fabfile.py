...
Base configuration
"""
env.project_name = 'lobby_adamsschool_com'
env.database_password = '$(db_password)'
env.site_media_prefix = "site_media"
env.admin_media_prefix = "admin_media"
env.path = '/var/www/vhosts/%(project_name)s' % env
env.log_path = '/var/www/vhosts/logs/%(project_name)s' % env
env.env_path = '%(path)s/venv' % env
